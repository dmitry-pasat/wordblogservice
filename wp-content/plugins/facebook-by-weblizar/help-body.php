																	...
																	<ul class="plugin-action-buttons-custom">
																		<li>
																			<?php 
																				...
																				switch($plugin["slug"])
																				{
																					case "add-pinterest-follow-button" :
																						?>
																							<a class="plugin-div-button install-now button" href="https://weblizar.com/plugins/pinterest-feed-pro/" target="_blank" >
		...
		<div class="section container">
			<div class="col-lg-6">
				...
				<ol id="weblizar_product">
					...
					<li><a href="https://weblizar.com/themes/fashionair-premium/">Fashionair </a></li>
					<li><a href="https://weblizar.com/themes/corporal-premium/">Corporal </a></li>
					<li><a href="https://weblizar.com/themes/explora-premium/">Explora </a></li>
					<li><a href="https://weblizar.com/themes/healthcare/">Healthcare </a></li>
					<li><a href="https://weblizar.com/themes/beautyspa-premium/">Beautyspa </a></li>
					<li><a href="https://weblizar.com/themes/scoreline-premium/">Scoreline </a></li>
			...
			<div class="col-lg-6">
				...
				<ol id="weblizar_product">
					<li><a href="https://weblizar.com/plugins/pinterest-feed-pro/">Pinterest Feed</a></li>
					<li><a href="https://weblizar.com/plugins/appointment-scheduler-pro/">Appointment Scheduler</a></li>
					<li><a href="https://weblizar.com/plugins/seo-image-optimizer-pro/">SEO Image Optimizer</a></li>
					<li><a href="https://weblizar.com/plugins/newsletter-subscription-form-pro/">Newsletter Subscription Form</a></li>
					<li><a href="https://weblizar.com/plugins/coming-soon-page-maintenance-mode-pro/">Coming Soon Page Maintenance Mode</a></li>					
					<li><a href="https://weblizar.com/plugins/recent-related-post-and-page-pro/">Recent Related Post and Page</a></li>
					<li><a href="http://weblizar.com/plugins/responsive-photo-gallery-pro/">Responsive Photo Gallery</a></li>
					<li><a href="https://weblizar.com/plugins/about-author-pro/">About Author</a></li>
